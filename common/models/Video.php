    ...
    public function rules()
    {
        return [
            ...
            [
                'video',
                'file',
                'extensions' => ['mp4', 'avi', 'mkv'], // Allow additional video formats
                'mimeTypes' => ['video/mp4', 'video/x-msvideo', 'video/x-matroska'], // Set corresponding MIME types
                // 'maxSize' => 1024 * 1024 * 100, // 100 MB max file size
                'tooBig' => 'The file is too large. Maximum size allowed is 400MB.', // Custom error message for large files
                'skipOnEmpty' => false // Prevent empty file uploads
            ],
